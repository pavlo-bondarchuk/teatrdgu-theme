...
function dgut_get_performance_card_data(WP_Post|int $post): array
{
    ...
    return [
        ...
        'age_rating' => function_exists('get_field') ? trim((string) get_field('dgut_performance_age_rating', $post_id)) : '',
...
function dgut_repertoire_card_data($post): array
{
    ...
    return [
        ...
        'age_rating' => isset($fields['dgut_performance_age_rating']) ? trim((string) $fields['dgut_performance_age_rating']) : '',
